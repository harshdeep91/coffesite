  ...
  return (
      <div className={styles.group21}>
          ...
          <div className={styles.group20}>
              <div className={styles.theControl}>The Control of Logical Loss</div>
              <div className={styles.regardless}>	•	Regardless of the fact that the center of the essential component involves some problems with The Efficiency of Slight Estimation (Kory Keck in The Book of the Major Area of Expertise) 
